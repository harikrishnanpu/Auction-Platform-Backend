...
class EndAuctionUseCase {
    ...
    async execute(auctionId, endedBy) {
        ...
        if (!auction) {
            throw new auction_errors_1.AuctionError(auction_errors_1.AuctionErrorCode.NOT_FOUND, auction_messages_1.AuctionMessages.NOT_FOUND);
        }
        ...
        if (auction.status !== 'ACTIVE') {
            throw new auction_errors_1.AuctionError(auction_errors_1.AuctionErrorCode.INVALID_STATUS, 'Only active auctions can be ended');
        }
