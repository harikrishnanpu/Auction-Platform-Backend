        ...
        try {
            ...
            return await this.transactionManager.runInTransaction(async (tx) => {
                ...
                if (secondsRemaining > 0 && secondsRemaining <= ANTI_SNIPE_THRESHOLD_SECONDS && auction.extensionCount < MAX_EXTENSIONS) {
                    ...
                    this.activityRepository.logActivity(auctionId, "AUCTION_EXTENDED", `Auction extended by ${ANTI_SNIPE_EXTENSION_SECONDS}s due to late bid (${newExtensionCount}/${MAX_EXTENSIONS})`, userId, {
