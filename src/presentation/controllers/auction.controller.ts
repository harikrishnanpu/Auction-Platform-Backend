...
export class AuctionController {
    ...
    public enter = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
            ...
            res.status(HttpStatus.OK).json({ success: true, data: participant });
        } catch (error) {
            next(error);
        }
    }
    ...
    public revokeUser = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
            ...
            res.status(HttpStatus.OK).json({ success: true, data: revoked });
        } catch (error) {
            next(error);
        }
    }
    ...
    public getConditions = async (req: Request, res: Response, next: NextFunction): Promise<void> => {
        try {
            ...
            res.status(HttpStatus.OK).json({ success: true, data: conditions });
        } catch (error) {
            next(error);
        }
    }
